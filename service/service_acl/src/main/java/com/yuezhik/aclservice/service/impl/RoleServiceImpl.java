...
import com.yuezhik.aclservice.entity.Role;
...
import com.yuezhik.aclservice.mapper.RoleMapper;
import com.yuezhik.aclservice.service.RolePermissionService;
import com.yuezhik.aclservice.service.RoleService;
...
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role> implements RoleService {
    ...
    @Override
    public void removeRoleId(String id) {
        QueryWrapper<RolePermission> wrapperP=new QueryWrapper<>();
        wrapperP.eq("role_id",id);
        QueryWrapper<UserRole> userWrapper=new QueryWrapper<>();
        userWrapper.eq("role_id",id);
        userService.remove(userWrapper);
        permissionService.remove(wrapperP);
